...
const VoucherTableListItem = (props: PropsType) => {
  const {
    data,
    onItemClick,
    handleEditDeal,
  ...
  return (
    <TableRow>
      ...
      <TableCell className="px-4 py-3 min-w-44 text-gray-500 text-start text-theme-sm dark:text-gray-400 capitalize">
        {data?.voucher_type?.replace("_", " ")}
      </TableCell>
      <TableCell className="px-4 py-3 min-w-44 text-gray-500 text-start text-theme-sm dark:text-gray-400">
        {data?.reduction_price ? `${data?.reduction_price} AED` : "-"}
      </TableCell>
      <TableCell className="px-4 py-3 min-w-44 text-gray-500 text-start text-theme-sm dark:text-gray-400">
...
export default VoucherTableListItem;
