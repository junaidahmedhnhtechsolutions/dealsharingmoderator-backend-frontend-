...
export default function DashboardCard(props: PropsType) {
  ...
  return (
    <Link to={href}>
      <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-4 flex flex-col items-center gap-2 hover:scale-105 transition-all duration-300 ease-in-out">
        ...
        <span className="text-base text-center text-nowrap text-gray-500 dark:text-gray-400">
          {title}
        </span>
