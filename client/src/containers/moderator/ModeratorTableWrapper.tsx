...
interface ModeratorTableWrapperProps {
...
const ModeratorTableWrapper: React.FC<ModeratorTableWrapperProps> = ({
  children,
  className = "",
  onRightBtnClick,
  rightBtnTitle,
  ...
  return (
    ...
    >
      ...
      <div className="sm:px-6 sm:py-5 p-4 gap-4 flex items-center justify-between sm:flex-row flex-col-reverse">
        ...
        <TableSearchBar placeholder="Search moderator" />
...
export default ModeratorTableWrapper;
